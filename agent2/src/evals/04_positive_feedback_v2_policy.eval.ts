...
export const positiveFeedbackPolicyEvalTests: EvalTest[] = [
    ...
    events: [
      ...positiveFeedbackEvents,
      {
        ...
        data: {
          ...
          input: { query: "positive feedback thank you response templates", limit: 5 },
          output: {
            results: [
              { title: "Positive Feedback Responses", content: "How to respond to customer appreciation and testimonials", relevance: 0.95 },
              { title: "Customer Success Stories", content: "Guidelines for handling positive customer feedback", relevance: 0.85 }
            ]
          }
        }
      }
    ...
    events: [
      ...
      },
      {
        ...
        data: {
          ...
          input: { id: "kb-002" },
          output: {
            content: "When responding to positive feedback, acknowledge the specific team member mentioned, express gratitude, and encourage future communication. Keep responses warm but professional."
          }
        }
      }
    ],
    ...
    events: [
      ...positiveFeedbackEvents,
      {
        ...
        data: {
          ...
          output: {
            summary: "Customer expressing gratitude for excellent support from Lisa. Positive feedback about integration issue resolution and response time.",
            keyPoints: ["Positive feedback", "Team member Lisa praised", "Integration issue resolved", "Response time appreciated"]
          }
        }
      }
    ],
  ...
  // Test 6: After category - compose draft (confident response)
  {
    ...
    expectedToolCall: {
      name: "compose_draft",
      args: {
        context: "Customer expressing gratitude for excellent support from Lisa regarding integration issue resolution.",
        tone: "professional",
        customer_name: "Anna"
      }
    }
