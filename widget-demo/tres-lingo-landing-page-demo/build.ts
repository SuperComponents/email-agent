...
// Scan for all HTML files in the project root (not src)
const entrypoints = Array.from(new Bun.Glob("**.html").scanSync("."))
  .map(a => path.resolve(".", a))
  .filter(dir => !dir.includes("node_modules") && !dir.includes("src"));
