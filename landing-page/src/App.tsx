          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16 max-w-4xl mx-auto animate-slide-up delay-1000">
              ...
              <div className="text-center group hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-sm text-muted-foreground mt-1 group-hover:text-foreground transition-colors">To Get Started</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="relative text-center space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black">
              <span className="block mb-2 text-foreground">Why teams are switching to</span>
              ...
              <div className="group cursor-pointer">
                <div className="relative">
                  ...
                  <div className="relative glass rounded-2xl p-8 hover-lift">
                    ...
                    <h3 className="text-xl font-bold mb-2">10x Faster Resolution</h3>
                    <p className="text-muted-foreground">AI handles 80% of queries instantly, freeing your team for complex issues</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="relative">
                  ...
                  <div className="relative glass rounded-2xl p-8 hover-lift">
                    ...
                    <p className="text-muted-foreground">Self-host on your infrastructure with complete data sovereignty</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="relative">
                  ...
                  <div className="relative glass rounded-2xl p-8 hover-lift">
                    ...
                    <p className="text-muted-foreground">Intuitive interface your team will love from day one</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="relative overflow-hidden gradient-border premium-card shadow-2xl scale-105 animate-slide-up delay-300">
              ...
              <CardContent className="p-8">
                ...
                <Button className="w-full bg-gradient-to-r from-purple-primary to-purple-light hover:from-purple-dark hover:to-purple-primary text-white border-0 shadow-lg hover:shadow-purple-primary/40 transition-all duration-300 hover:scale-105" asChild>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4 group">
                ...
                <span className="text-xl font-bold gradient-text">OpenSupport</span>
              </div>
