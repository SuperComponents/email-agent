...
async function seed() {
  try {
    ...
    const insertedEmails = await db
      ...
      .values([
        ...
        },
        {
          ...
          body_text:
            "Hello! I'd be happy to help you with your login issues. Can you try resetting your password?",
          body_html:
            "<p>Hello! I'd be happy to help you with your login issues. Can you try resetting your password?</p>",
          direction: 'outbound',
          sent_at: new Date(),
        },
        {
        ...
        },
        {
          ...
          body_text:
            "Thank you for your feedback. We've updated our API documentation with more examples.",
          body_html:
            "<p>Thank you for your feedback. We've updated our API documentation with more examples.</p>",
          direction: 'outbound',
      ...
      .values([
        {
          ...
          thread_id: insertedThreads[0].id,
          generated_content:
            'Thank you for contacting support. I can help you resolve your login issues. Please try the following steps: 1) Clear your browser cache, 2) Try a different browser, 3) Reset your password using the forgot password link.',
          status: 'pending',
        ...
        },
        {
          ...
          thread_id: insertedThreads[1].id,
          generated_content:
            'Hi there! Your subscription is set to auto-renew on the 15th of next month. The renewal cost will be $49.99. You can manage your subscription settings in your account dashboard.',
          status: 'approved',
        ...
        },
        {
          ...
          thread_id: insertedThreads[2].id,
          generated_content:
            'Thank you for your feature request. We appreciate your feedback about our API documentation. Our development team is working on improving the documentation with more comprehensive examples.',
          status: 'rejected',
        ...
        },
        {
          ...
          thread_id: insertedThreads[2].id,
          generated_content:
            "Thank you for your valuable feedback regarding our API documentation. We've reviewed your request and have updated our documentation with additional examples and use cases. You can find the updated documentation at docs.company.com/api.",
          status: 'sent',
          created_by_user_id: insertedUsers[2].id, // Mike Admin
    ...
    console.log(
      `- Agent actions: ${insertedActions.length} (email_read, draft_created, draft_approved, thread_status_changed)`,
    );
  } catch (error) {
