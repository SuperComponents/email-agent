...
export const loginIssuePolicyEvalTests: EvalTest[] = [
            ...
            results: [
              {
                ...
                content: "Password reset, account lockout, email verification",
                relevance: 0.9,
              },
              {
                title: "Authentication Troubleshooting",
                content: "Check credentials, clear cache, verify email",
                relevance: 0.8,
              },
            ],
          },
    ...
    events: [
      ...
      },
      {
        ...
        data: {
          ...
          output: {
            content:
              "Login issues are often caused by incorrect credentials, browser cache, or email verification problems. First check password reset process.",
          },
        },
      },
    ],
    ...
    events: [
      ...loginIssueEvents.slice(0, 2),
      {
        ...
        data: {
          ...
          output: {
            summary:
              "Customer experiencing login issues with invalid credentials error. Password reset not working. Urgent business need for access.",
            keyPoints: [
              "Authentication failure",
              "Password reset issues",
              "Time-sensitive customer need",
            ],
          },
        },
      },
            ...
            results: [
              {
                ...
                content: "Email delivery problems and troubleshooting",
                relevance: 0.95,
              },
            ],
          },
    ...
    events: [
      ...loginIssueEvents.slice(0, 3),
      {
        ...
        data: {
          ...
          output: {
            content:
              "Password reset emails may be delayed or blocked. Check spam folder, verify email address, and try alternative reset methods.",
          },
        },
      },
    ],
  ...
  // Test 9: Customer escalates - determine if user action needed or draft
  {
    ...
    events: [
      ...loginIssueEvents.slice(0, 4),
      {
        ...
        data: {
          ...
          output: {
            summary:
              "Customer unable to login with authentication errors. Password reset emails not received. Multiple troubleshooting attempts failed. Time-sensitive business need.",
            keyPoints: [
              "Authentication failure",
    ...
    expectedToolCall: {
      ...
      args: {
        thread_id: "thread_123",
        reason:
          "Complex login issue with failed password reset. Customer needs manual account verification due to time constraints.",
        priority: "high",
      },
    },
  },
  ...
  // Test 10: Alternative path - compose draft for simple case
  {
    ...
    events: [
      ...
      // After knowledge base operations and context summary...
      {
        ...
        data: {
          ...
          output: {
            summary:
              "Simple password reset request. Standard procedure available in knowledge base.",
            keyPoints: [
    ...
    expectedToolCall: {
      ...
      args: {
        context:
          "Customer requesting password reset assistance. Standard procedure available.",
        tone: "helpful",
    ...
    events: [
      {
        ...
        data: {
          ...
          output: {
            draft:
              "Hi! I'd be happy to help you reset your password. Please click the 'Forgot Password' link on our login page and follow the instructions. You should receive a reset email within 5 minutes. Let me know if you need any assistance!",
            confidence: 0.9,
          },
        },
      },
